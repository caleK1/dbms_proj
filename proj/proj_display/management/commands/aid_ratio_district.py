...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        save_years=[20132014,20142015,20152016,20162017,20172018,20182019,20192020,20202021,20212022,20222023,20232024,20242025]
        i=-1

        for year in self.years:
            i+=1
            file_path=f'/Users/calek/DBMS/dbms_proj/data/FinancialData/FinancialDataElements/AidRatios/cleaned_adr{year}.csv'
            try:
